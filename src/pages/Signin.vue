        ...
        <q-card square class="shadow-24" style="width:300px;height:500px;">
          <q-card-section class="bg-deep-purple-7">
            ...
            <div class="absolute-bottom-right q-pr-md" style="transform: translateY(50%);">
              <q-btn fab icon="add" color="purple-4" @click="$router.replace('/signup')"/>
            </div>
          </q-card-section>
          <q-card-section>
...
export default {
  ...
  methods: {
     ...
     login: function () {
      ...
      let auth = api.post('/auth/signin',{username: this.email, password: this.password} ).then(() => this.$router.push('/'))
